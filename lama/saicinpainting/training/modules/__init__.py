...
from custom_nodes.ComfyUI_Lam.lama.saicinpainting.training.modules.ffc import FFCResNetGenerator
from custom_nodes.ComfyUI_Lam.lama.saicinpainting.training.modules.pix2pixhd import GlobalGenerator, MultiDilatedGlobalGenerator, \
