...
# from custom_nodes.ComfyUI_Lam.lama.saicinpainting.evaluation.masks.mask import SegmentationMask
from custom_nodes.ComfyUI_Lam.lama.saicinpainting.utils import LinearRamp
